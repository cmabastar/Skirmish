...
namespace Forge {
	...
	StartSpot@[] spots = {
		...
		StartSpot(AIFloat3(  2000, 0, 4000), AiRole::FRONT_TECH, false),        
		StartSpot(AIFloat3(  1900, 0, 5200), AiRole::FRONT_TECH, false),    
	...
	MapConfig config = MapConfig("Forge", mapUnitLimits, spots, getFactoryWeights());
