...
namespace TundraContinents {
	...
	StartSpot@[] spots = {
		StartSpot(AIFloat3(  300, 0,  460), AiRole::HOVER_SEA, true),       
		StartSpot(AIFloat3(  1700, 0, 2300), AiRole::HOVER_SEA, false),       
		...
		StartSpot(AIFloat3(  9200, 0, 1500), AiRole::HOVER_SEA, false),

		StartSpot(AIFloat3(  1504, 0,  12000), AiRole::SEA, false),       
		StartSpot(AIFloat3(  1610, 0, 10300), AiRole::SEA, false),       
		StartSpot(AIFloat3(  2800, 0, 11400), AiRole::HOVER_SEA, false),        
	...
	MapConfig config = MapConfig("Tundra Continents", getMapUnitLimits(), spots, getFactoryWeights(), getRoleUnitLimits());
