...
local infos = {
	{
		key    = 'shortName',
		value  = 'FartAI', -- AI name - !This comment is used for parsing!
	...
	{
		key    = 'description',
		value  = 'FartAI - Aggressive group-based tactics with adaptive aggression, cluster bombing, and economy raiding.',
		desc   = 'tooltip.',
	},
	{
		key    = 'url',
